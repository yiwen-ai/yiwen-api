...
func newRouters(apis *APIs) []*gear.Router {
	...
	router.Get("/v1/publication/list_published", middleware.AuthAllowAnon.Auth, apis.Publication.ListPublished)
	router.Post("/v1/publication/list_published", middleware.AuthAllowAnon.Auth, apis.Publication.ListPublished)
	router.Get("/v1/publication/list", middleware.AuthAllowAnon.Auth, apis.Publication.List)  // 匿名时等价于 list_published
	...
	router.Get("/v1/collection/list", middleware.AuthAllowAnon.Auth, apis.Collection.List)
	router.Post("/v1/collection/list", middleware.AuthAllowAnon.Auth, apis.Collection.List)
	router.Get("/v1/collection/list_latest", middleware.AuthAllowAnon.Auth, apis.Collection.ListLatest)
	router.Post("/v1/collection/list_latest", middleware.AuthAllowAnon.Auth, apis.Collection.ListLatest)
	router.Get("/v1/collection/list_children", middleware.AuthAllowAnon.Auth, apis.Collection.ListChildren)
	...
	router.Get("/v1/creation/list", middleware.AuthToken.Auth, apis.Creation.List)
	router.Post("/v1/creation/list", middleware.AuthToken.Auth, apis.Creation.List)
	router.Get("/v1/creation/list_archived", middleware.AuthToken.Auth, apis.Creation.ListArchived)
	...
	router.Get("/v1/publication/list_by_following", middleware.AuthToken.Auth, apis.Publication.ListByFollowing)
	router.Get("/v1/publication/list_archived", middleware.AuthToken.Auth, apis.Publication.ListArchived)
	...
	router.Get("/v1/collection/list_archived", middleware.AuthToken.Auth, apis.Collection.ListArchived)
	...
	router.Get("/v1/bookmark/list", middleware.AuthToken.Auth, apis.Bookmark.List)
	...
	router.Get("/v1/group/list_my", middleware.AuthToken.Auth, apis.Group.ListMy)
	router.Post("/v1/group/list_my", middleware.AuthToken.Auth, apis.Group.ListMy)
	router.Get("/v1/group/list_following", middleware.AuthToken.Auth, apis.Group.ListFollowing)
